...
async def compare_images_async(client, rate_limiter, index_a, index_b, local_dir="../../synthetic_posts/nameless/"):
    """
    Compare two images using Gemini 2.5 Flash - async version
...
async def main():
    ...
    rate_limiter = RateLimiter(max_requests_per_minute=2000)
    
    # Setup output
    output_file = "results/nameless_results_gemini_2_5_flash_lite_async.csv"
    ...
    print(f"Expected completion time: ~{len(remaining_pairs)/2000:.1f} minutes")
    print("=" * 60)
