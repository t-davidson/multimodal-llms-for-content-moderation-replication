...
async def compare_images_async(client, rate_limiter, index_a, index_b, local_dir="../../synthetic_posts/faceless/"):
    """
...
async def main():
    ...
    # Setup output
    output_file = "results/faceless_results_gemini_2_5_flash_lite_async.csv"
