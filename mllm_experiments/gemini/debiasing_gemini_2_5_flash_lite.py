...
async def compare_images_async(client, rate_limiter, index_a, index_b, local_dir="../output/"):
    ...
    try:
        ...
        system_instruction = (
            ...
            "Context is essential in content moderation decisions. Insults directed at dominant groups, such as white people, "
            "differ from expressions of hatred targeting minorities. Members of marginalized groups may also reclaim slurs, "
            "using them in ways that should not be classified as hate speech.\n\n"
        ...
        # Generate content using Gemini 2.5 (note additional argument for thinking)
...
async def main():
    ...
    rate_limiter = RateLimiter(max_requests_per_minute=3500)
    
    # Setup output
    output_file = "results/debiasing_results_gemini_2_5_flash_lite_async.csv"
    ...
    print(f"Rate limit: 3500 requests/minute")
    print(f"Expected completion time: ~{len(remaining_pairs)/3500:.1f} minutes")
    print("=" * 60)
