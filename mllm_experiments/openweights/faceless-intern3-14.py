...
def compare_images(index_a, index_b):
    ...
    # Paths for images
    local_dir = "../../synthetic_posts/faceless/"
...
# Store results
results = []
output_file = "results/faceless_results_internvl3_14b.csv"
...
print("Comparison completed and results saved to faceless_results_internvl3_14b.csv")